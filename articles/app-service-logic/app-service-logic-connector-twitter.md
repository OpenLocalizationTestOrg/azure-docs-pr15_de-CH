<properties
   pageTitle="Mit dem Twitter-Connector Logik Apps | Microsoft Azure App Service"
   description="Zum Erstellen und Konfigurieren der Twitter-Connector oder API-app und in einer Anwendung Logik in Azure App Service verwenden"
   services="logic-apps"
...
# <a name="weve-improved-the-twitter-connector"></a>Wir haben Twitter-Connector verbessert. 
...
- [Erfahren Sie mehr über diese neuen Connector](../connectors/connectors-create-api-twitter.md)
