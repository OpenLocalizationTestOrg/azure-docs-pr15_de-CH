<properties
pageTitle="Excel-Verbindung hinzufügen | Microsoft Azure"
description="Übersicht über Excel Connector mit REST-API"
services=""    
documentationCenter=""     
authors="msftman"    
manager="erikre"    
...
# <a name="get-started-with-the-excel-connector"></a>Erste Schritte mit Excel-connector

Derzeit gibt es kein Excel-Connector in Logik-Apps. 

## <a name="to-use-excel-data"></a>Verwenden von Excel-Daten
Sie können Excel-Daten als eine durch Kommas getrennte Werte (CSV) in einen Speicherordner wie [OneDrive](connectors-create-api-onedrive.md)speichern. Sie können auch diese CSV-Datei mit [Flatfile - Connector](../app-service-logic/app-service-logic-enterprise-integration-flatfile.md)verwenden.
